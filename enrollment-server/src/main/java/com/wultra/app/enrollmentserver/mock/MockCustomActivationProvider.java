...
public class MockCustomActivationProvider implements CustomActivationProvider {
    ...
    @Override
    public Map<String, Object> processCustomActivationAttributes(Map<String, Object> customAttributes, String activationId, String userId, String applId, ActivationType activationType, Map<String, Object> context) {
